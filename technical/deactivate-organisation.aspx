<%@ Page Language="VB" AutoEventWireup="false" CodeFile="deactivate-organisation.aspx.vb" Inherits="_Default" %>
...
<div class="grid_6">
				<div class="block-border">
					<div class="block-header">
						<h1>Deactivate Organisation</h1><span></span>
					</div>
					<div class="block-content">
...
<ItemTemplate>
    <tr  runat="server">
        ...
        <td  > <asp:CheckBox ID="CheckBox1" runat="server" checked='<%# Eval("Inactive")%>' /> </td>
     ...
     <EditItemTemplate>
              <tr    runat="server">
                  <td> <asp:Button ID="Button1" runat="server" Text="Update" CommandName="Update" /> &nbsp; <asp:Button ID="Button2" runat="server" Text="Cancel" CommandName="Cancel" /></td>
        <td > <asp:Label ID="CustomerLabel" runat="server" Text='<%#Eval("AccountIdName") %>' /> </td>
        <td   > <asp:CheckBox ID="CheckBox1" runat="server" checked='<%# Bind("Inactive")%>' /> </td>
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Reactivate Organisation</h1><span></span>
					</div>
					<div class="block-content">

                        <asp:ListView ID="ListView2" runat="server" DataSourceID="LinqDataSource2" DataKeyNames="OrganisationID">
                            <LayoutTemplate>
<table id="organisation2-table" class="table">
    <thead>
        <tr>
            <th></th>
<th>Customer</th>
    ...
    <tr  runat="server">
     ...
     <EditItemTemplate>
        ...
        <td   > <asp:CheckBox ID="CheckBox1" runat="server" checked='<%# Bind("Inactive")%>' /> </td>
						...
						<asp:LinqDataSource ID="LinqDataSource2" runat="server" ContextTypeName="Support2DataClassesDataContext" EnableUpdate="True" EntityTypeName="" TableName="OrganisationDetails" Where="Inactive == @Inactive">
                            <WhereParameters>
                                <asp:Parameter DefaultValue="True" Name="Inactive" Type="Boolean" />
                            </WhereParameters>
                        </asp:LinqDataSource>
...
<div class="grid_12"></div>
	<div class="grid_6">
				<div class="block-border">
					<div class="block-header">
						<h1>Deactivate/Reactivate Site</h1><span></span>
					</div>
					<div class="block-content"><br /><br />
                        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="LinqDataSource3" DataTextField="AccountIdName" DataValueField="OrganisationID" AppendDataBoundItems="true" AutoPostBack="True">
                            <asp:ListItem Value="">Select Customer</asp:ListItem>
                        </asp:DropDownList>

                        <asp:LinqDataSource ID="LinqDataSource3" runat="server" ContextTypeName="Support2DataClassesDataContext" EntityTypeName="" OrderBy="AccountIdName" TableName="OrganisationDetails">
                        </asp:LinqDataSource><br /><br />
                        <asp:ListView ID="ListView3" runat="server" DataSourceID="LinqDataSource4" EditIndex="0">
<LayoutTemplate>
    <table id="site-deactivate-table" class="table">
    <thead>
        <tr>
            <th></th>
<th>Site</th>
    ...
    <tbody>
        <tr runat="server" id="itemPlaceholder"></tr>
                  ...
                  <td> <asp:Button ID="Button1" runat="server" Text="Update" CommandName="Update" /> &nbsp; <asp:Button ID="Button2" runat="server" Text="Cancel" CommandName="Cancel" /></td>
        <td > <asp:Label ID="CustomerLabel" runat="server" Text='<%#Eval("SiteName")%>' /> </td>
        <td   > <asp:CheckBox ID="CheckBox1" runat="server" checked='<%# Bind("Active")%>' /> </td>
        ...
        <td   > <asp:CheckBox ID="CheckBox1" runat="server" checked='<%# Bind("Active")%>' /> </td>
                        ...
                        <asp:LinqDataSource ID="LinqDataSource4" runat="server" ContextTypeName="Support2DataClassesDataContext" EntityTypeName="" TableName="Sites" Where="OrganisationID == @OrganisationID" EnableUpdate="True" StoreOriginalValuesInViewState="False">
                            <WhereParameters>
