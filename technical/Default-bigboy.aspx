...
<asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="TechnicalDataClassesDataContext" EntityTypeName="" TableName="SelectOrganisationIDByEmployeeIDViews" OrderBy="AccountIdName" Where="EmployeeID == @EmployeeID">
    <WhereParameters>
        <asp:ControlParameter ControlID="Label16" Name="EmployeeID" PropertyName="Text" Type="Int32" />
    </WhereParameters>
    </asp:LinqDataSource>
    <asp:Label ID="Label16" runat="server" Text="Label" Visible="False"></asp:Label><br /><br />
...
<div class="block-content">
				...
				<div class="block-border" >
					...
					<div class="block-content tab-container" id="tab-technical"><br />
                        <ul class="tabs">
							<li><a href="#tab-1">Organisation</a></li>
							<li><a href="#tab-2">Devices</a></li>
							<li><a href="#tab-3">Applications</a></li>
                            <li><a href="#tab-4">Internet</a></li>
                            <li><a href="#tab-5">Documents</a></li>
                            <li><a href="#tab-6">Networks</a></li>
                            <li><a href="#tab-7">Policies</a></li>
						</ul>
						...
						<div id="tab-2" class="tab-content">
                         <div style="width: 99%; margin-left: 7px"> <asp:ListView ID="ListView1" runat="server" DataSourceID="LinqDataSource2" DataKeyNames="DeviceID" >
                                ...
                                <ItemTemplate>
                                     <tr style="">
                                         <td> <asp:Button ID="SelectButton" runat="server" CommandName="Select" Text="Select" /></td>
                                        
                                        <td>
                                            <asp:Label ID="SiteNameLabel" runat="server" Text='<%# Eval("SiteName") %>' />
                                        </td>
                                        <td>
                                            <asp:Label ID="HostNameLabel" runat="server" Text='<%# Eval("HostName") %>' />
                                        </td>
                                        ...
                                        <td>
                                            <asp:Label ID="DeviceStatusIDLabel" runat="server" Text='<%# Eval("DeviceStatus")%>' />
                                        </td>
                                ...
                                <LayoutTemplate>
                                                ...
                                                <table id="DeviceTable" class="table"   >
                                                    ...
                                                    <tr id="Tr2" runat="server" style="">
                                                        <th id="selectdevice" runat="server" >Select</th>
                                                        <th id="Th1" runat="server">SiteName</th>
<th id="Th2" runat="server">HostName</th>
                                                        
                                                        
                                                        <th id="Th8" runat="server">Active</th>
                                                        <th id="Th9" runat="server">DeviceStatus</th>
                                ...
                                <SelectedItemTemplate>
                                    <tr style="">
                                        ...
                                        <td>
                                            <asp:Label ID="ModelNumberLabel" runat="server" Text='<%# Eval("ModelNumber") %>' />
                                        </td>
                                        <td>
                                            <asp:Label ID="SerialNumberLabel" runat="server" Text='<%# Eval("SerialNumber") %>' />
                                        </td>
                                        <td>
                                            <asp:Label ID="ThirdPartyDetailsLabel" runat="server" Text='<%# Eval("ThirdPartyDetails") %>' />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Label ID="ParentDeviceIDLabel" runat="server" Text='<%# Eval("ParentDevice")%>' />
                                        </td>
                                ...
                                <asp:LinqDataSource ID="LinqDataSource2" runat="server" ContextTypeName="TechnicalDataClassesDataContext" EntityTypeName="" TableName="DeviceOrganisationSiteParentViews" Where="OrganisationID == @OrganisationID &amp;&amp; Active == @Active" OrderBy="HostName">
                                    <WhereParameters>
					...
					<div class="block-content dark-bg">
						<p>
                            <asp:Label ID="Label1" runat="server" Text="Select a Customer"></asp:Label></p>
					</div>
				</div>
			</div>
<div class="grid_6">
    <div class="block-border" >
					...
					<div class="block-content tab-container" id="Div1">
                        <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="125px" EmptyDataText="No data was returned" AutoGenerateRows="False" DataKeyNames="DeviceID" DataSourceID="LinqDataSource3">
                            <Fields>
                                <asp:BoundField DataField="DeviceID" HeaderText="DeviceID" InsertVisible="False" ReadOnly="True" SortExpression="DeviceID" />
                                ...
                                <asp:BoundField DataField="DeviceStatusID" HeaderText="DeviceStatusID" SortExpression="DeviceStatusID" />
                                <asp:BoundField DataField="DeviceTypeID" HeaderText="DeviceTypeID" SortExpression="DeviceTypeID" />
                                <asp:BoundField DataField="ParentDeviceID" HeaderText="ParentDeviceID" SortExpression="ParentDeviceID" />
                                <asp:BoundField DataField="ExternalSubnetID" HeaderText="ExternalSubnetID" SortExpression="ExternalSubnetID" />
                                <asp:BoundField DataField="InternalSubnetID" HeaderText="InternalSubnetID" SortExpression="InternalSubnetID" />
                                ...
                                <asp:BoundField DataField="InternalIP" HeaderText="InternalIP" SortExpression="InternalIP" />
                                ...
                                <asp:BoundField DataField="OperatingSystemID" HeaderText="OperatingSystemID" SortExpression="OperatingSystemID" />
                                <asp:BoundField DataField="ThirdPartyDetails" HeaderText="ThirdPartyDetails" SortExpression="ThirdPartyDetails" />
                                <asp:CheckBoxField DataField="Active" HeaderText="Active" SortExpression="Active" />
                            </Fields>
                        </asp:DetailsView>
                        <asp:LinqDataSource ID="LinqDataSource3" runat="server" ContextTypeName="TechnicalDataClassesDataContext" EntityTypeName="" TableName="Devices" Where="DeviceID == @DeviceID">
                            <WhereParameters>
                                <asp:ControlParameter ControlID="ListView1" Name="DeviceID" PropertyName="SelectedValue" Type="Int32" />
                            </WhereParameters>
                        </asp:LinqDataSource>
                </div>
        <div class="block-content dark-bg">
						<p>
                            <asp:Label ID="Label2" runat="server" Text="Select an Item"></asp:Label></p>
					</div>
        </div></div>
...
$("#tab-technical").tabs({ cookie: { expires: 30 } });
