<%@ Page Language="VB" AutoEventWireup="false" CodeFile="credentials.aspx.vb" Inherits="technical_credentials2" %>
  ...
  <div id="container">
			...
			<div class="grid_12">
				<div class="block-border">
					<div class="block-header">
						<h1>Credentials</h1><span></span>
					</div>
					<div class="block-content">
						<p><strong>Create a credential: </strong>devices belong to sites and therefore a new site must be created first if it does not already exist</p>
						<div class="clear"></div>
					</div>
				</div>
			</div>
    ...
    <li><a href="#tab-3">Deactivate</a></li>
                        ...
                        <div id="tab-1" class="tab-content">
                          ...
                          <table id="newcredentialsform">
                      
                        
                        <tbody>

                    <tr><th scope="row">Customer</th> <td> 
<asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="LinqDataSource1" DataTextField="AccountIdName" DataValueField="OrganisationID" AppendDataBoundItems="true">
                            ...
                            <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="Support2DataClassesDataContext" EntityTypeName="" OrderBy="AccountIdName" TableName="OrganisationDetails">
                            </asp:LinqDataSource>

                                                      </td></tr>
                            <tr> <th scope="row">Type</th>
                                <td> <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="LinqDataSource2" DataTextField="CredentialsType" DataValueField="CredentialsTypeID" AppendDataBoundItems="true">
                                    <asp:ListItem Value="">Select Credentials Type</asp:ListItem>
                                     </asp:DropDownList>
                                    <asp:LinqDataSource ID="LinqDataSource2" runat="server" ContextTypeName="Support2DataClassesDataContext" EntityTypeName="" OrderBy="CredentialsType" TableName="CredentialsTypes">
                                    </asp:LinqDataSource>
                                </td></tr> 
                            <tr><th scope="row">Application</th> 
                                <td> <asp:DropDownList ID="DropDownList3" runat="server" AppendDataBoundItems="true">
                                    <asp:ListItem Value="">Select Application</asp:ListItem>
                                     </asp:DropDownList></td></tr>
                            <tr> <th scope="row>">Device</th><td>
                                <asp:DropDownList ID="DropDownList4" runat="server" AppendDataBoundItems="true">
                                    <asp:ListItem Value="">Select Device</asp:ListItem>
                                </asp:DropDownList> </td></tr>
                    <tr> <th scope="row">Account</th><td> &nbsp;</td></tr>
                    <tr> <th scope="row">UserName</th><td> &nbsp;</td></tr>
                    <tr><th scope="row">Password</th> <td>&nbsp;</td></tr>
                    <tr> <th scope="row">Status</th><td> &nbsp;</td></tr>
