<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit-organisation.aspx.vb" Inherits="_Default" %>
    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<div class="grid_12">
				...
				<div class="block-border">
					<div class="block-header">
						<h1>Edit Organisation</h1><span></span>
					</div>
					<div class="block-content">

                        <asp:ListView ID="ListView1" runat="server" DataSourceID="LinqDataSource1" DataKeyNames="OrganisationID">
                            <LayoutTemplate>
<table id="organisation-table" class="table">
    <thead>
        <tr>
            <th></th>
<th>Customer</th>
...
<ItemTemplate>
    <tr runat="server">
        <td>
            <asp:Button ID="EditButton" runat="server" Text="Edit" CommandName="Edit" /> </td>
        <td > <asp:Label ID="CustomerLabel" runat="server" Text='<%#Eval("AccountIdName") %>' /> </td>
        <td  > <asp:Label ID="DescriptionLabel" runat="server" Text='<%#Eval("OrganisationDescription")%>' /> </td>
     ...
     <EditItemTemplate>
        ...
        <td runat="server" > <asp:Label ID="CustomerLabel" runat="server" Text='<%# Eval("AccountIdName") %>' /> </td>
        <td runat="server"   > <asp:TextBox ID="DescriptionTextBox" runat="server" Text='<%# Bind("OrganisationDescription") %>' TextMode="MultiLine" Columns="70" /> </td>
						...
						<asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="Support2DataClassesDataContext" EnableUpdate="True" EntityTypeName="" TableName="OrganisationDetails" Where="Inactive != @Inactive">
                            <WhereParameters>
                ...
                <div class="grid_6">
                    <div class="block-border">
					<div class="block-header">
						<h1>Edit Site</h1><span></span>
					</div>
					<div class="block-content form"><br /><br />
                        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="LinqDataSource2" DataTextField="AccountIdName" DataValueField="OrganisationID" AppendDataBoundItems="true">
                            <asp:ListItem Value="">Select Customer</asp:ListItem>
                        </asp:DropDownList><br /><br />



                        <asp:LinqDataSource ID="LinqDataSource2" runat="server" ContextTypeName="Support2DataClassesDataContext" EntityTypeName="" TableName="OrganisationDetails" OrderBy="AccountIdName">
                        </asp:LinqDataSource>
                        <asp:FormView ID="FormView1" runat="server" AllowPaging="True" DataKeyNames="SiteID" DataSourceID="LinqDataSource3" DefaultMode="Edit">
                            <EditItemTemplate>
<table>
    <tr>
        <td> <strong>Site</strong></td>
        <td> <asp:TextBox ID="SiteNameTextBox" runat="server" Text='<%# Bind("SiteName") %>' Columns="60"  /></td>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="You must enter a site name" CssClass="smallwarning" ValidationSummary="ValidationSummary1" ControlToValidate="SiteNameTextBox" ValidationGroup="ValidationGroup1" >*</asp:RequiredFieldValidator>
    </tr>
    <tr>
        <td> <strong>Description</strong></td>
        <td> <asp:TextBox ID="SiteDescriptionTextBox" runat="server" Text='<%# Bind("SiteDescription") %>' Columns="60"  TextMode="MultiLine" /></td>
                              ...
                              <asp:ValidationSummary ValidationGroup="ValidationGroup1" CssClass="smallwarning" runat="server"></asp:ValidationSummary>  
                                <br /><br />
                                
                                <asp:Button ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update" ValidationGroup="ValidationGroup1" Text="Update" />
                        ...
                        <asp:LinqDataSource ID="LinqDataSource3" runat="server" ContextTypeName="Support2DataClassesDataContext" EnableUpdate="True" EntityTypeName="" TableName="Sites" Where="OrganisationID == @OrganisationID">
                            <WhereParameters>
